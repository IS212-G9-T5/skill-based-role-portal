...
Revision ID: 4d46176f1ca8
Revises: 
Create Date: 2023-10-04 15:28:09.349962
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "access_control_name",
            sa.Enum("User", "Admin", "Manager", "HR", name="accesscontrolrole"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("OPEN", "CLOSED", "PENDING", name="rolestatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "application_status",
            sa.Enum("ACCEPTED", "REJECTED", "PENDING", name="applicationstatus"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["role_listing_id"],

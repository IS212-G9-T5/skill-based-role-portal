...
const AllRoleListing: React.FC = () => {
  ...
  const [filteredDataSkills, setFilteredDataSkills] = useState([]);
  ...
  useEffect(() => {
    ...
    if (searchLowerCase === "" && Object.values(activeFilter).every((value) => !value)) {
  ...
  return (
    ...
    <div className="flex">
      {/* Left Panel */}
      <div className="w-1/4 p-4 flex flex-col sticky top-0 h-screen overflow-y-auto">
